...
const BasicStepForm = () => {
  ...
  const { moveNext, setDisconnectedInfraEnv } = useClusterWizardContext();
    ...
    <ClusterWizardStep
      ...
      footer={
        <ClusterWizardFooter
          ...
          isNextDisabled={
            isLoading || (cluster ? false : !values.openshiftVersion) || (!isInOcm && !isValid)
          }
...
const getBasicStepValidationSchema = (t: ReturnType<typeof useTranslation>['t']) =>
  Yup.lazy((_values: BasicStepFormikValues) =>
    Yup.object().shape({
